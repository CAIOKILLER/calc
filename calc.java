		...
		String secondNumber =
		   ...
		   int number2 = Integer.parseInt (secondNumber);
                   ...
                   if (op  == 2) {
                       ...
                       JOptionPane.showMessageDialog(null, "A subtração é " + sub," Soma de dois numeros inteiros", JOptionPane.PLAIN_MESSAGE );
                         }
                    if (op  == 3) {
                       int div = number1 / number2;
                       JOptionPane.showMessageDialog(null, "A divisão é " + div," Soma de dois numeros inteiros", JOptionPane.PLAIN_MESSAGE );
                         }
                   if (op  == 4) {
                       int mult = number1 + number2;
                       JOptionPane.showMessageDialog(null, "A multiplicação é " + mult," Soma de dois numeros inteiros", JOptionPane.PLAIN_MESSAGE );
                         }
